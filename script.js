console.log("HCC Pixels 3.0 - Frontend Connected");
// Select your elements as before
...
const url = `http://localhost:3000/search-images?
query=${encodeURIComponent(inputData)}&page=${page}`;
try {
...
imageWrapper.classList.add("searchResult", "fade");
